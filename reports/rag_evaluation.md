...
*Généré le 2026-09-14 19:20:36 par `python manage.py run_rag_eval` — journal complet : [`rag_evaluation.json`](rag_evaluation.json)*
...
| Latence retrieval p50 / p95 | 0.99 ms / 1.07 ms |
...
|---|---|---|---|---|---|---|---|---|
| 34 | 0.15 | 6449 | 28 | 1.02 | 1.117 | 1.146 | 0.759 | 0.778 |
| 500 | 0.92 | 7145 | 284 | 1.369 | 1.463 | 1.504 | 0.796 | 0.815 |
| 2 000 | 3.38 | 7958 | 1127 | 2.286 | 2.486 | 2.596 | 0.796 | 0.815 |
| 5 000 | 8.31 | 9490 | 2753 | 3.977 | 4.354 | 4.837 | 0.796 | 0.815 |
| 10 000 | 16.51 | 12045 | 5534 | 6.754 | 7.371 | 7.568 | 0.796 | 0.815 |
| 20 000 | 32.93 | 15159 | 11596 | 11.882 | 12.58 | 12.917 | 0.796 | 0.815 |
...
| Chunks | Index (Mo) | Dim | Build (ms) | p50 (ms) | p95 (ms) | p99 (ms) | Recall@4 | MRR |
|---|---|---|---|---|---|---|---|---|
| 34 | 0.15 | 6449 | 35 | 0.898 | 0.993 | 1.076 | 0.759 | 0.778 |
| 500 | 2.75 | 6785 | 323 | 2.416 | 3.116 | 3.832 | 0.562 | 0.512 |
| 2 000 | 11.09 | 7598 | 1316 | 6.084 | 7.189 | 7.586 | 0.346 | 0.321 |
| 5 000 | 27.77 | 9130 | 3291 | 13.117 | 14.697 | 15.053 | 0.284 | 0.222 |
| 10 000 | 55.52 | 11685 | 7560 | 26.186 | 30.513 | 32.837 | 0.235 | 0.161 |
| 20 000 | 111.06 | 14799 | 16187 | 52.451 | 61.695 | 69.715 | 0.148 | 0.099 |
